...
\begin{itemize} %função para organizar as questões em itens
    ...
    \\\\Resolução:
    \\\\
    \\\\\item[] \textbf{d)} $\prod\limits_{i=5}^{10} i$
    \\\\Resolução:
    \\\\
    \\\\\item[] \textbf{e)} $\prod\limits_{i=1}^8 i$
    \\\\Resolução:
    \\\\
    \item[] \textbf{Questão 5 -} Encontre os somatórios para as sequências com os seguintes termos:
    \\\\\textbf{a)} $1 + 2 + 4 + 8 + 16 + 32 + 64 + ... + 2^n$
    \\\\Resolução:
    \\\\
    \\\\
    \textbf{b)} $\frac{1}{2} + \frac{1}{6} + \frac{1}{12} + ... + \frac{1}{n\cdot (n + 1)}$
    \\\\Resolução:
    \\\\
    \\\\
    \textbf{c)} $1\cdot 1! + 2\cdot 2! + ... + n\cdot n!$
    \\\\Resolução:
    \\\\
    \\\\
    \textbf{d)} $1 + \frac{1}{\sqrt{2}} + \frac{1}{\sqrt{3}} + \frac{1}{2} + \frac{1}{\sqrt{5}} + ... + \frac{1}{\sqrt{n}}$
    \\\\Resolução:
    \\\\
    \\\\
    \textbf{e)} $\frac{3}{2} + \frac{3}{4} + \frac{3}{8} + \frac{3}{16} + ... + \frac{3}{2^n}$
    \\\\Resolução:
    \\\\
    \\\\
